...
function ensureHomeNewsletter(container, resourcesSection) {
  ...
  newsletter.innerHTML = `
    <div class="newsletter-shell">
      ...
      <section class="newsletter-lead">
        <article class="lead-story">
          <p class="story-tag">Lead Story</p>
          <h3>OpenAI launches GPT-5.4 for professional and agentic workflows</h3>
          <p>OpenAI introduced GPT-5.4 with stronger coding, tool use, computer-use capabilities, and long-context performance for professional work.</p>
          <p class="story-takeaway"><strong>Why it matters:</strong> AI platforms are shifting from chat interfaces toward practical agent workflows that can search, plan, act, and verify.</p>
        </article>
      </section>
      <section class="newsletter-grid" aria-label="Weekly AI stories">
        <article class="news-card"><p class="story-tag">Products</p><h3>ChatGPT adds Excel workflows and financial data integrations</h3><p>OpenAI announced ChatGPT for Excel and new integrations for spreadsheet-heavy workflows.</p><p class="story-takeaway"><strong>Why it matters:</strong> AI adoption is moving deeper into everyday business tools.</p></article>
        <article class="news-card"><p class="story-tag">Models</p><h3>Google rolls out Gemini 3.1 Flash-Lite</h3><p>Google introduced a lower-cost, high-volume model for production tasks.</p><p class="story-takeaway"><strong>Why it matters:</strong> Cost and speed are now critical deployment metrics.</p></article>
        <article class="news-card"><p class="story-tag">Enterprise</p><h3>Microsoft expands Dragon Copilot in healthcare</h3><p>New clinical workflow features and partner app integrations were announced at HIMSS 2026.</p><p class="story-takeaway"><strong>Why it matters:</strong> Vertical AI assistants are becoming enterprise platforms.</p></article>
        <article class="news-card"><p class="story-tag">Security</p><h3>Anthropic partners with Mozilla on Firefox security</h3><p>The partnership emphasizes AI in defensive and trust-focused infrastructure use cases.</p><p class="story-takeaway"><strong>Why it matters:</strong> Security outcomes are increasingly central to AI value.</p></article>
        <article class="news-card"><p class="story-tag">Devices</p><h3>MWC 2026 spotlights AI-first hardware</h3><p>Vendors highlighted AI-native laptops, tablets, and new concept devices.</p><p class="story-takeaway"><strong>Why it matters:</strong> AI is now a core device selling point.</p></article>
      </section>
      <section class="newsletter-bottom">
        ...
        <div class="newsletter-footer"><p><strong>Published:</strong> March 8, 2026</p><p><strong>Coverage window:</strong> ${aiWeeklyIssue.coverageWindow}</p></div>
      </section>
    </div>
  `;
